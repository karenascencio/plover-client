...
export default function PaymentHistoryButton ({ image, reference }) {
  return (
    <Link href={reference}>
      <a className=' sm:ml-5px md:ml-10px md:h-30px p-1 h-30px w-30px item-center place-content-center justify-items-center rounded hover:bg-light-blue border-plover-blue border-2 '>

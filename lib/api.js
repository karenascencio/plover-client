...
export const getDentistById = async (id) => {
  const response = await fetch(`${BASE_URL}/dentists/${id}`, getConfig)
  const json = await response.json()
  return json.data.dentist
}

export const getPatientsByDentistId = async (id) => {
  const response = await fetch(`${BASE_URL}/dentists/${id}/patients`, getConfig)
  const json = await response.json()
  return json.data.patientsByDentist
}

export const getAppointmentsByDentistId = async (id) => {
  const response = await fetch(`${BASE_URL}/dentists/${id}/appointments`, getConfig)
  const json = await response.json()
...
export const  signIn = async (dentistData) => {
     const signin = {
       method: 'POST',
       headers: {
         Accept: 'application/json',

...
const api = {
  ...
  // async getPatientNameById (id) {
  //   const response = await fetch(`${BASE_URL}/patients/${id}`)
  //   const json = await response.json()
  //   const name = json.data.patient.name
  //   const lastName = json.data.patient.lastName
  //   const trimmedName = name.split(' ', 1).join() + ' ' + lastName.split(' ', 1).join()
  //   return trimmedName
  // },
